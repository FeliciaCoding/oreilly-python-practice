...
Source code and Jupyter Notebooks files for my "Python Fundamentals LiveLessons, 2/e" videos on O'Reilly Online Learning, which are under development (2026). 
